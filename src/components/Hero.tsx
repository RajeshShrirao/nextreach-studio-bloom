...
export default function Hero() {
  return (
    <header className="relative pt-32 pb-24 px-6 max-w-6xl mx-auto overflow-hidden">
      ...
      <div className="absolute top-20 left-1/2 -translate-x-1/2 w-[700px] h-[500px] pointer-events-none">
        ...
        <div className="absolute top-10 right-1/4 w-64 h-64 rounded-full bg-emerald-500/[0.04] blur-[80px] animate-float-delayed" />
        <div className="absolute -top-5 left-1/2 -translate-x-1/2 w-96 h-40 rounded-full bg-orange-500/[0.03] blur-[120px] animate-pulse-glow" />
      </div>

      {/* Floating particles */}
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        <div className="absolute top-[15%] left-[10%] w-1 h-1 rounded-full bg-amber-400/20 animate-float-slow" />
        <div className="absolute top-[25%] right-[15%] w-1.5 h-1.5 rounded-full bg-emerald-400/15 animate-float-delayed" />
        <div className="absolute top-[40%] left-[20%] w-0.5 h-0.5 rounded-full bg-amber-300/25 animate-float" />
        <div className="absolute top-[10%] right-[25%] w-1 h-1 rounded-full bg-orange-400/10 animate-float-slow" />
      </div>

      <div className="relative z-10 flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
        {/* Copy */}
        <div className="flex-1 text-center lg:text-left">
          <div className="inline-flex items-center gap-2 mb-5 px-3 py-1 rounded-full border border-zinc-800 bg-zinc-900/50 text-xs text-zinc-400 font-medium tracking-wide backdrop-blur-sm">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-white tracking-tight leading-[1.1] mb-6 glow-text">
            ...
            <span className="text-amber-400/90">new best hire.</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4">
            <a
              href="#pricing"
              className="w-full sm:w-auto px-8 py-4 bg-amber-400 text-black font-semibold rounded-lg hover:bg-amber-300 transition-all btn-primary-glow"
            >
